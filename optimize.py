...
lower_bounds = [288, 101300, 0.2,      1, 1.15, 1,    0, 0,    0, 0]
upper_bounds = [288, 101300, 0.2, np.inf, 1.7, 15, 0.15, 1, 0.05, 0.05]
...
ST_const = NonlinearConstraint(lambda x: vectorized_engine(x)["ST"], 1230, 1230)
