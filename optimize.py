...
def optimize(T_a, p_a, M, ST, x0):
    ...
    lower_bounds = [T_a, p_a, M, 1, 1, 0, 0, 0, 0, 0]
    upper_bounds = [T_a, p_a, M, 55, 1, 0, 0.15, 0, 0.05, 0.05]
...
if __name__ == "__main__":
    ...
    M = 0.2
    ST = 1230
    x = np.array([T_a, p_a, M, 42.217638036620976, 1, 0, 0.15, 0, 0.02789954000189713, 0.02860040271923639])
